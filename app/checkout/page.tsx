...
type Confirmation = { order_number: string; total: number };
...
export default function CheckoutPage() {
  ...
  if (confirmation) return <main className="form-page shell"><div className="success-card"><CheckCircle weight="fill"/><span className="kicker dark">ORDER CONFIRMED</span><h1>Thank you for your order.</h1><p>Your order number is <strong>{confirmation.order_number}</strong>. Save it to track your cash-on-delivery order.</p><Link href="/track-order" className="primary-btn inline">Track your order</Link></div></main>;
